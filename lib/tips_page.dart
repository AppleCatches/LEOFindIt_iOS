    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          _tip('Leave the phone still and alone with a package that could have a tag.'),
          _tip('Move slowly when changing scan positions so signal changes are easier to interpret.'),
          _tip('Re-scan from multiple positions to see whether the same device remains strong nearby.'),
          _tip('A stronger RSSI usually suggests the device is closer, but walls, metal, and containers can distort readings.'),
          _tip('Use the advanced scanner to compare UUID, RSSI, and distance instead of relying on one reading alone.'),
